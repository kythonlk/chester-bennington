      ...
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <a href="https://988lifeline.org/" target="_blank" rel="noreferrer" className="block p-6 border border-zinc-700 hover:border-lp-accent hover:bg-zinc-800/50 transition-all rounded group">
             ...
             <a href="https://320changesdirection.org/" target="_blank" rel="noreferrer" className="block p-6 border border-zinc-700 hover:border-lp-accent hover:bg-zinc-800/50 transition-all rounded group">
